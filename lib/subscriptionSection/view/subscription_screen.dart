...
// //     final List<Widget> reversedPlanCards = vm.plans.map((plan) {
...
// //                               ),
// //                               child: const Icon(Icons.emoji_events, color: Colors.amber, size: 34),
// //                             ),
// //                             SizedBox(height: 8.h),
// //                             Text(
// //                               'Subscriptions',
...
// //               Column(
// //                 children: [
// //                   Icon(Icons.workspace_premium, color: Colors.amber.shade700, size: 22.sp),
// //                   SizedBox(height: 4.h),
// //                   Text('Upgrade Required', style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w600)),
// //                   SizedBox(height: 4.h),
// //                   Text(
...
// //                   children: [
// //                     Text('Why Upgrade?', style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w600)),
// //                     SizedBox(height: 8.h),
// //                     _bullet('Get started with basic predictions', Colors.blue),
// //                     _bullet('Advanced predictions with higher accuracy', Colors.amber),
...
// //           SizedBox(width: 8.w),
// //           Text(text, style: TextStyle(fontSize: 12.5.sp, color: Colors.black87)),
// //         ],
// //       ),
// //     );
// //   }
