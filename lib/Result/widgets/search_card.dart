  ...
  //             'CHECK',
  //             style: TextStyle(
  //               color: canShow ? AppColors.primaryBlueDark : Colors.grey[500],
  //               fontSize: 16.sp,
  //               fontWeight: FontWeight.w600,
  //               letterSpacing: 1,
  //             ),
  ...
  //               _showSmoothSnackBar(
  //                 context,
  //                 'Please select a valid lottery name and date',
  //               );
  //             } else {
  //               provider.showResults();
  //             }
  ...
  void _filterLotteries(String query) {
    setState(() {
      if (query.isEmpty) {
        ...
        _filteredLotteries = _lotteryNames
            .where((lottery) => lottery.toLowerCase().contains(query.toLowerCase()))
            .toList();
      }
    });
  }
    ...
    return Material(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: () {
            FocusScope.of(context).unfocus();
            if (_searchController.text.isEmpty || provider.selectedDate == null) {
              _showSmoothSnackBar(
                context,
                'Please select a valid lottery name and date',
              );
